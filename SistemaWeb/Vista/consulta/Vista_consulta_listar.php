            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <select class="js-example-basic-single" name="state" id="cbm_paciente_consulta"
                            style="width:100%;">
                        </select><br>
                    </div>
                    <div class="col-lg-4">
                        <label for="">Insumo utilizado</label>
                        <select class="js-example-basic-single" name="state" id="cbm_insumo_consulta"
                            style="width:100%;">
                        </select>
                    </div>
                    <div class="col-lg-4">
                        <label for="">Cant. Insumo utilizado</label>
                        <input type="text" class="form-control" id="txt_cantinsumo_consulta"
                            placeholder="Ingrese Cantidad"><br>
                    </div>
                    <div class="col-lg-4">
                        <label for="">Servicio anexado</label>
                        <select class="js-example-basic-single" name="state" id="cbm_servicio_consulta"
                            style="width:100%;">
                        </select><br>
                    </div>
                    <div class="col-lg-6"><br>
                        <label for="">Descripci&oacute;n</label>
                        <textarea name="" id="txt_descripcion_consulta" rows="4" class="form-control"
                            style="resize:none"></textarea>
                    </div>
                    <div class="col-lg-6"><br>
                        <label for="">Observaci&oacute;n</label>
                        <textarea name="" id="txt_observacion_consulta" rows="4" class="form-control"
                            style="resize:none"></textarea>
                    </div>
                </div>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <select class="js-example-basic-single" name="state" id="cbm_paciente_editar"
                            style="width:100%;">
                        </select><br><br>
                    </div>
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-12"><br>
                        <label for="">Descripci&oacute;n</label>
                        <textarea name="" id="txt_descripcion_editar" rows="4" class="form-control"
                            style="resize:none"></textarea>
                    </div>
                </div>
